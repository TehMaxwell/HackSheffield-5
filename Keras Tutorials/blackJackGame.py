...
#FUNCTIONS
def playerHand(deck, playerBusts):
    playerCount = 0
    playerPlaying = True
...
def machineHand(deck, model, machineBusts):
    machineCount = 0
    machinePlaying = True
...
while handCount <= numberOfHands:
    ...
    if playerOrMachine == 1:
        playerCount, playerBusts = playerHand(deck, playerBusts)
        
        if playerCount > 21:
            machineWins += 1
            
        else:
            machineCount, machineBusts = machineHand(deck, NN, machineBusts)
